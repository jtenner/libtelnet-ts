...
function getEnvironVars(pointer, size, heap) {
    ...
    for (var i = 0; i < size; i++, pointer += 12) {
        ...
        result.push({
            ...
            value: valueStringPointer === 0
                ? null
                : util_1.AsciiToString(telnet, valueStringPointer),
            var: varStringPointer === 0 ? null : util_1.AsciiToString(telnet, varStringPointer),
        });
    }
    return result;
}
...
var TelnetEvent = /** @class */ (function () {
    function TelnetEvent(pointer) {
        this.pointer = pointer;
        var heap = util_1.getDataView(telnet);
    ...
    Object.defineProperty(TelnetEvent.prototype, "data", {
        ...
        get: function () {
            ...
            var heap = util_1.getDataView(telnet);
            var bufferPointer = heap.getUint32(pointer + consts_1.consts.data_t_buffer_offset, true);
            var bufferLength = heap.getUint32(pointer + consts_1.consts.data_t_size_offset, true);
            return {
                type: this.type,
                buffer: new Uint8Array(heap.buffer.slice(bufferPointer, bufferPointer + bufferLength)),
                size: bufferLength,
            };
        },
        enumerable: false,
    ...
    Object.defineProperty(TelnetEvent.prototype, "error", {
        ...
        get: function () {
            ...
            return {
                errcode: errcode,
                file: util_1.AsciiToString(telnet, filePointer),
                func: util_1.AsciiToString(telnet, funcPointer),
                line: line,
                msg: util_1.AsciiToString(telnet, messagePointer),
                type: this.type,
            };
        },
        enumerable: false,
    ...
    Object.defineProperty(TelnetEvent.prototype, "iac", {
        ...
        get: function () {
            return {
                type: this.type,
                cmd: util_1.getDataView(telnet).getUint8(this.pointer + consts_1.consts.iac_t_cmd_offset),
            };
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(TelnetEvent.prototype, "negotiate", {
        ...
        get: function () {
            return {
                type: this.type,
                telopt: util_1.getHeapU8(telnet)[this.pointer + consts_1.consts.negotiate_t_telopt_offset],
            };
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(TelnetEvent.prototype, "zmp", {
        ...
        get: function () {
            ...
            for (var i = 0; i < argc; i++) {
                ...
                var stringPointer = heap.getUint32(argvPointer + (i << consts_1.consts.U32_ALIGN), true);
                var value = util_1.AsciiToString(telnet, stringPointer);
                argv.push(value);
            }
            return {
                argc: argc,
    ...
    Object.defineProperty(TelnetEvent.prototype, "ttype", {
        ...
        get: function () {
            ...
            var name = util_1.AsciiToString(telnet, namePointer) || "";
            return {
                cmd: cmd,
                name: name,
                type: this.type,
    ...
    Object.defineProperty(TelnetEvent.prototype, "compress", {
        ...
        get: function () {
            return {
                type: this.type,
                state: util_1.getHeapU8(telnet)[this.pointer + consts_1.consts.compress_t_state_offset] === 1,
            };
        },
        enumerable: false,
        configurable: true
