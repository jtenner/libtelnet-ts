...
function getEnvironVars(pointer, size, heap) {
    ...
    for (var i = 0; i < size; i++, pointer += 12) {
        ...
        result.push({
            ...
            var: varStringPointer === 0 ? null : telnet.AsciiToString(varStringPointer),
        });
    }
    return result;
}
...
var TelnetEvent = /** @class */ (function () {
    ...
    Object.defineProperty(TelnetEvent.prototype, "iac", {
        ...
        get: function () {
            return {
                type: this.type,
                cmd: new DataView(telnet.HEAPU8.buffer).getUint8(this.pointer + consts_1.consts.iac_t_cmd_offset),
            };
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(TelnetEvent.prototype, "negotiate", {
        ...
        get: function () {
            return {
                type: this.type,
                telopt: telnet.HEAPU8[this.pointer + consts_1.consts.negotiate_t_telopt_offset],
            };
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(TelnetEvent.prototype, "zmp", {
        ...
        get: function () {
            ...
            for (var i = 0; i < argc; i++) {
                ...
                var value = stringPointer === 0 ? null : telnet.AsciiToString(stringPointer);
                argv.push(value);
            }
            return {
                argc: argc,
    ...
    Object.defineProperty(TelnetEvent.prototype, "ttype", {
        ...
        get: function () {
            ...
            var name = namePointer === 0 ? "" : telnet.AsciiToString(namePointer);
            return {
                cmd: cmd,
                name: name,
                type: this.type,
    ...
    Object.defineProperty(TelnetEvent.prototype, "compress", {
        ...
        get: function () {
            return {
                type: this.type,
                state: telnet.HEAPU8[this.pointer + consts_1.consts.compress_t_state_offset] === 1,
            };
        },
        enumerable: false,
        configurable: true
