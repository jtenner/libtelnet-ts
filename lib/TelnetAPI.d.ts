import { TelnetFlag, TelnetCommand, TelnetOption, TelnetNegotiationCommand } from "./consts";
export interface TelnetAPI {
    ...
    _telnet_negotiate(telnet: number, cmd: TelnetNegotiationCommand, option: TelnetOption): void;
    ...
    _telnet_subnegotiation(telnet: number, telopt: TelnetOption, buffer: number, size: number): void;
    HEAPU8: Uint8Array;
...
//# sourceMappingURL=TelnetAPI.d.ts.map