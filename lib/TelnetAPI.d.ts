...
export interface TelnetAPI {
    ...
    telnet_negotiate(telnet: number, cmd: TelnetNegotiationCommand, option: TelnetOption): void;
    ...
    telnet_subnegotiation(telnet: number, telopt: TelnetOption, buffer: number, size: number): void;
